...
public class MBSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MBSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MBSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MBSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MBSDateTimeConverter dateTimeConverter = new MBSStandardDateTimeConverter();

    public MBSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MBSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MBSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MBSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MBSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MBSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
