...
public class MBSKPSPublicSoap
{
    ...
    public MBSKPSPublicSoap(){}

    public MBSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MBSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MBSExtendedSoapSerializationEnvelope envelope= new MBSExtendedSoapSerializationEnvelope(MBSExtendedSoapSerializationEnvelope.VER11);
